...
import com.celadonsea.palm.security.CertificateLoader;
import com.celadonsea.palm.security.CredentialStore;
import com.celadonsea.palm.security.MessageTlsSocketFactory;
...
public class MqttMessageClient implements MessageClient {
     ...
     */
    private final MqttClientConfig messageClientConfig;
     ...
     */
    public MqttMessageClient(MessageClientConfig messageClientConfig, CredentialStore credentialStore) {
        this.messageClientConfig = (MqttClientConfig) messageClientConfig;
     ...
     * @param messageClientConfig client configuration
     */
    public MqttMessageClient(MessageClientConfig messageClientConfig) {
        this.messageClientConfig = (MqttClientConfig) messageClientConfig;
    }
     ...
     * the {@link MqttCallBack} instance.
     *
