...
import com.celadonsea.palm.controller.SharedMessageController;
...
public class MqttCallBackTest {
    ...
    public void setup() {
        ...
        callBack = new MqttCallBack(messageClient, config);
    ...
    private MessageClientConfig getConfig() {
        return new MqttClientConfig() {
            ...
            public String getClientDialect() {
                return "com.celadonsea.palm.client.TestMessageClient";
            }
